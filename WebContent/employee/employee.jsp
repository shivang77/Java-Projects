			...
			<div class="col-lg-9 col-md-9 col-sm-9">
				<div class="row">
					...
					<div class="col-sm-3 col-lg-3 col-md-3">
					   ...
					   <div class="col-sm-2 col-lg-2 col-md-2">
						&nbsp;&nbsp;&nbsp;&nbsp;<a href="addemployee.jsp"><button class="btn btn-info">Add Employee</button></a>
					</div>
				 </div>
				<br><br>
				<div class="table-responsive">
					<table class="table table-bordered table-responsive table-hover">
						...
						<tr>
							<%
								List<Employee> list = new EmployeeDaoImpl().getAll();
									if (list.size() != 0) {
										for (Employee e : list) {
							...
							<td><%= e.getType() %></td>
							<td><%= e.getSalary()%></td>
							<td><a href="editemployee.jsp?employeeid=<%=employeeid%>">EDIT</a>&nbsp;&nbsp;&nbsp;<a
								href="../DeleteEmployeeServlet?employeeid=<%=employeeid%>">DELETE</a>&nbsp;&nbsp;&nbsp;<a
