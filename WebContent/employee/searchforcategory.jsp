				...
				<div class="table-responsive">
					<table class="table table-bordered table-responsive table-hover">
						...
						<tr>
							...
							<td><%= e.getType()%></td>
							<td><%= e.getSalary()%></td>
							<td><a href="editemployee.jsp?employeeid=<%=employeeid%>&flag=searchcategory">EDIT</a>&nbsp;&nbsp;&nbsp;<a
								href="../DeleteEmployeeServlet?employeeid=<%=employeeid%>&flag=searchcategory">DELETE</a>&nbsp;&nbsp;&nbsp;<a
