...
function getCourse(str) {
	 var xhttp; 
	  ...
	  xhttp.open("GET", "batchgetcourse.jsp?coursename="+str, true);
...
<div class="container-fluid">
	...
	<div class="thumbnail">
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 col-sm-9">
				<div class="row">
					<div class="col-sm-2 col-lg-2 col-md-2">
						<a href="addbatch.jsp"><button class="btn btn-info">Add Batch</button></a>
					</div>  
			...
			<td><a href="editbatch.jsp?batchid=<%=batchid%>">EDIT</a>&nbsp;&nbsp;&nbsp;<a href="../DeleteBatchServlet?batchid=<%=batchid%>">DELETE</a></td>
			</tr>
			<%
			}
			}
