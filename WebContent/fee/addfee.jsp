		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 col-sm-9">
				...
				<div class="col-sm-6  col-md-6 col-lg-6 thumbnail">
					...
					<hr>
					<form class="form-horizontal" action="../InsertFeeServlet" method="post">
						 <div class="form-group">
						    <label class="control-label col-sm-4">Fee Id:</label>
						    <div class="col-sm-7">
						      	<input type="text" name="feeid" class="form-control" value=<%= new FeeDaoImpl().generateID() %> readonly>
						    </div>
						 </div>
						 <div class="form-group">
						    <label class="control-label col-sm-4">Student Id:</label>
						    <div class="col-sm-7">
						      	<input type="text" name="studentid" class="form-control" placeholder="Enter Student Id" required="required">
						    </div>
						 </div>
						 <div class="form-group">
						 ...
						 <div class="form-group">
						    ...
						    <div class="col-sm-7">
						      	<input type="text" name="submitfee" class="form-control" placeholder="Enter submit fee" required="required">
						    </div>
						 </div>
						 <div class="form-group">
						    <label class="control-label col-sm-4">Receiver:</label>
						    <div class="col-sm-7">
						      	<input type="text" name="receiver" class="form-control" placeholder="Enter receiver" required="required">
						    </div>
						 </div>
						 <div class="form-group">
						    <label class="control-label col-sm-4">Due Date:</label>
						    <div class="col-sm-7">
						      	<input type="date" name="duedate" class="form-control" placeholder="Enter Duedate" required="required">
						    </div>
						 </div>
						 <br>
						  <div class="form-group"> 
