		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 col-sm-9">
				...
				<div class="table-responsive">
					...
					<td><a href="../course/editcourse.jsp?courseid=<%= course.getCourseid() %>&flag=searchbranchcourse">EDIT</a>&nbsp;&nbsp;&nbsp;<a href="../DeleteCourseServlet?courseid=<%= course.getCourseid() %>&flag=searchbranchcourse">DELETE</a></td>
					</tr>
					<%
						}
					%>
