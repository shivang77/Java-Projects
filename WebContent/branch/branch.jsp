			...
			<div class="col-lg-9 col-md-9 col-sm-9">
				<div class="row">
					<div class="col-sm-2 col-lg-2 col-md-2">
						<a href="addbranch.jsp"><button class="btn btn-info">Add Branch</button></a>
					</div>
				...
				<div class="table-responsive">
					<table class="table table-bordered table-responsive table-hover">
						...
						<tr>
							...
							<td><a href="editbranch.jsp?branchid=<%=branchid%>">EDIT</a>&nbsp;&nbsp;&nbsp;<a href="../DeleteBranchServlet?branchid=<%=branchid%>">DELETE</a></td>
						</tr>
						<%
						}
						}
