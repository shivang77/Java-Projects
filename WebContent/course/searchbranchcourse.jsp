...
<body>
<%
List<Course> list=(List<Course>)session.getAttribute("list");
					    ...
					    <div class="col-sm-3 col-lg-3 col-md-3">   
					      ...
					      <div class="input-group">
					        ...
					        <div class="input-group-btn">
					          <a href="addbranch.jsp"><button class="btn btn-default" type="submit">
...
<td><a href="editcourse.jsp?courseid=<%= course.getCourseid() %>&flag=searchbranchcourse">EDIT</a>&nbsp;&nbsp;&nbsp;<a href="../DeleteCourseServlet?courseid=<%= course.getCourseid() %>&flag=searchbranchcourse">DELETE</a></td>
</tr>
<%
	}
%>
