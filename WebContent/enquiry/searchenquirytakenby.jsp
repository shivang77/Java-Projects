				  ...
				  <div class="table-responsive">
					<table class="table table-bordered table-responsive table-hover">
						<tr class="info">
							...
							<td><a href="editenquiry.jsp?enquiryid=<%=enquiryid%>&takenby=<%=enquiry.getTakenby()%>">EDIT</a>&nbsp;&nbsp;&nbsp;<a
								href="../DeleteEnquiryServlet?enquiryid=<%=enquiryid%>&takenby=<%=enquiry.getTakenby()%>">DELETE</a>&nbsp;&nbsp;&nbsp;<a
