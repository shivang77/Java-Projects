...
<%
		...
		Enquiry enquiry=(Enquiry)session.getAttribute("enquiry");
				  ...
				  <div class="table-responsive">
					<table class="table table-bordered table-responsive table-hover">
						...
						<% 
							...
							<td><a href="editenquiry.jsp?enquiryid=<%= enquiry.getEnquiryid()%>&flag=search">EDIT</a>&nbsp;&nbsp;&nbsp;<a
								href="../DeleteEnquiryServlet?enquiryid=<%= enquiry.getEnquiryid()%>&flag=search">DELETE</a>&nbsp;&nbsp;&nbsp;<a
								href="../followup/followup.jsp?enquiryid=<%=enquiry.getEnquiryid()%>">FOLLOWUP</a></td>
						</tr>
						<%} %>
