				  ...
				  <div class="table-responsive">
					<table class="table table-bordered table-responsive table-hover">
						<tr class="info">
							...
							<td><a href="editenquiry.jsp?enquiryid=<%=enquiryid%>&name=<%=enquiry.getEnquiryname()%>">EDIT</a>&nbsp;&nbsp;&nbsp;<a
								href="../DeleteEnquiryServlet?enquiryid=<%=enquiryid%>&name=<%=enquiry.getEnquiryname()%>">DELETE</a>&nbsp;&nbsp;&nbsp;<a
