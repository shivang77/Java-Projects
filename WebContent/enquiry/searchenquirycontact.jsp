...
<%
		...
		List<Enquiry> list=(List<Enquiry>)session.getAttribute("list");
				  ...
				  <div class="table-responsive">
					<table class="table table-bordered table-responsive table-hover">
						<tr class="info">
							...
							<td><a href="editenquiry.jsp?enquiryid=<%=enquiryid%>&searchcontact=<%=enquiry.getContact()%>">EDIT</a>&nbsp;&nbsp;&nbsp;<a
								href="../DeleteEnquiryServlet?enquiryid=<%=enquiryid%>&searchcontact=<%=enquiry.getContact()%>">DELETE</a>&nbsp;&nbsp;&nbsp;<a
