			...
			<div class="col-lg-9 col-md-9 col-sm-9">
				<div class="row">
					...
					<div class="col-sm-3 col-lg-3 col-md-3">
					   ...
					   <div class="col-sm-3 col-lg-3 col-md-3" style="margin-top:8px;">
						&nbsp;&nbsp;&nbsp;&nbsp;<a href="addstudent.jsp"><button class="btn btn-info">Add Student</button></a>
					</div>
				 </div>
				<br><br>
				<div class="table-responsive">
					...
					<tr>
						...
						for(Student student:list)
						{
							...
							<td><a href="editstudent.jsp?studentid=<%=studentid%>&flag=student&flag1=student">EDIT</a>&nbsp;&nbsp;&nbsp;<a href="../DeleteStudentServlet?studentid=<%=studentid%>&flag=studenti&flag1=student">DELETE</a>&nbsp;&nbsp;&nbsp;<a href="viewstudent.jsp?studentid=<%=studentid%>">VIEW</a></td>
							</tr>
							<%
							}
							}
