...
<body>
	<%
		...
		if (u1 != null) {
			List<EmpCategory> list=(List<EmpCategory>)session.getAttribute("list");
				  ...
				  <div class="table-responsive">
					<table class="table table-bordered table-responsive table-hover">
						...
						<tr>
							...
							<td><a href="editempcategory.jsp?categoryid=<%=categoryid%>&flag=search">EDIT</a>&nbsp;&nbsp;&nbsp;<a
								href="../DeleteEmpCategoryServlet?categoryid=<%=categoryid%>&flag=search&category=<%= empcategory.getCategoryname()%>">DELETE</a></td>
						</tr>
						<%
							}
								} else {
